...
import static com.example.allu.bank.Utils.URL.ANOMOLY_URL;
...
public class AnamolousUtils {
    String TAG = AnamolousUtils.class.getSimpleName();
    Context context;
    RequestQueue queue;
    Utils utils;
    ...
    public AnamolousUtils(Context context,RecyclerView recyclerView,Adapter_transaction adapter_transaction) {
    ...
    public void getTransactionList(){
        utils.setProgressDialogMessage("Loading anomolous transactions..");
        utils.showDialog();
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, ANOMOLY_URL, param, new Response.Listener<JSONObject>() {
            @Override
